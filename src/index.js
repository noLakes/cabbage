...
if(!db.fetch_raw().fields[0]) {
  db.add_field('General');
    db.add_head('0', 'Get groceries', 'info', format(new Date(2021, 0, 25, 23, 59), 'MM/dd/yyyy/HH/mm'));
    ...
    db.add_head('0', 'Clean Shower', 'info', format(new Date(2021, 0, 28, 12, 0), 'MM/dd/yyyy/HH/mm'));
