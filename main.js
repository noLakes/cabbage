...
const controller = (function() {
  ...
  const initFields = () => {
    ...
    for(let key in fields) {
      const fieldEl = _dom__WEBPACK_IMPORTED_MODULE_1__.render.fieldNav(fields[key]);
      fieldEl.addEventListener("click", activate);
      _dom__WEBPACK_IMPORTED_MODULE_1__.elements.field_links_container.appendChild(fieldEl);
    }
  }

  const reloadFields = () => {
    const activeUid = document.querySelector('.active').dataset.uid;
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.field_links_container.innerHTML = '';
    initFields();
  ...
  const open_field_form = () => {
    const form = _dom__WEBPACK_IMPORTED_MODULE_1__.render.new_field_form();
    
    form.querySelector('input.submit_field').addEventListener('click', (e) => {
      const name = form.querySelector('input.field_name').value;
      _data__WEBPACK_IMPORTED_MODULE_0__.default.add_field(name)
      _dom__WEBPACK_IMPORTED_MODULE_1__.elements.new_field_button.disabled = false;
    ...
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.field_links_container.appendChild(form);
  }
  ...
  const assign_head_form_listeners = (form) => {
    ...
    form.querySelector('input.submit-head').addEventListener('click', (e) => {
      _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head(
  ...
  const loadNewHeadForm = (uid) => {
    const new_head_form = _dom__WEBPACK_IMPORTED_MODULE_1__.render.new_head_form(uid);
    assign_head_form_listeners(new_head_form);
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.content.appendChild(new_head_form);
  }

  const open_field_edit_form = (field) => {
    const edit_form = _dom__WEBPACK_IMPORTED_MODULE_1__.render.edit_field_form(field);

    edit_form.querySelector('.submit-edit').addEventListener('click', (e) => {
      _data__WEBPACK_IMPORTED_MODULE_0__.default.update_item(field.uid, {name : edit_form.querySelector('.edit-field-name').value});
      reloadFields();
      loadField(field.uid);
    })
  ...
  const loadFieldHeading = (field) => {
    const fieldHeading = _dom__WEBPACK_IMPORTED_MODULE_1__.render.fieldHeading(field);
    fieldHeading.querySelector('.edit-field').addEventListener('click', (e) => {
      e.target.parentElement.remove();
      open_field_edit_form(field);
    })
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.content.prepend(fieldHeading);
  }
  ...
  const update_head = () => {
    _data__WEBPACK_IMPORTED_MODULE_0__.default.update_item(
      document.querySelector('.modal-content').dataset.uid,
      {
        ...
        due : (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(document.querySelector('.due-input').valueAsNumber + 14400000), 'MM/dd/yyyy'),
      }
    )
  }
  ...
  const open_head_modal = (head) => {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.modal.appendChild(_dom__WEBPACK_IMPORTED_MODULE_1__.render.head_modal(head));
    toggle_modal();
  }

  const loadHead = (head) => {
    const tile = _dom__WEBPACK_IMPORTED_MODULE_1__.render.head_tile(head);
    tile.addEventListener('click', () => {
      open_head_modal(head);
    })
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.content.appendChild(tile);
  }
  ...
  const loadHandler = (target) => {
    if(target.classList.contains('time-link')) {
      switch(target.id) {
        case 'today':
          loadBatch(_data__WEBPACK_IMPORTED_MODULE_0__.default.dateQuery(endOfDay()));
          break
        case 'upcoming':
          loadBatch(_data__WEBPACK_IMPORTED_MODULE_0__.default.dateQuery(twoWeeks()));
          break
        default:
          loadBatch(_data__WEBPACK_IMPORTED_MODULE_0__.default.fetchHeadsByDue());
      }
    }
    else {
  ...
  _dom__WEBPACK_IMPORTED_MODULE_1__.elements.new_field_button.addEventListener('click', (e) => {
    open_field_form();
...
const db = (function() {
  ...
  const add_leaf = (parent_uid, name) => {
    const leaf = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.Leaf)(name);
    const parent = fetch(parent_uid);
  ...
  const parseDate = (head) => {
    if(!head.due) return;
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(head.due, 'MM/dd/yyyy', new Date());
  }

  const formatDateBrowser = (head) => {
    if(!head.due) return '';
    const date = parseDate(head);
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(date, 'yyyy/MM/dd').replace(/\//g,'-');
  }
...
const render = (function() {
  return {
      ...
      const container = elements.basic('div', 'leaf-form-container');
        ...
        save.addEventListener('click', () => {
          if(edit) {
            ...
            _data__WEBPACK_IMPORTED_MODULE_1__.default.add_leaf(document.querySelector('.modal-content').dataset.uid, name.value);
            const head = _data__WEBPACK_IMPORTED_MODULE_1__.default.fetch(document.querySelector('.modal-content').dataset.uid);
    ...
    leaf(leaf) {
      ...
      const actionContainer = elements.basic('div', 'action-container');
        ...
        del.addEventListener('click', () => {
          _data__WEBPACK_IMPORTED_MODULE_1__.default.remove(leafContainer.dataset.uid);
    ...
    head_tile(head) {
      ...
      if((0,_objects__WEBPACK_IMPORTED_MODULE_0__.childCount)(head)) {
        const listRatio = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.childCompleteRatio)(head);
    ...
    head_modal(head) {
      ...
      const headerContainer = elements.basic('div', 'header-container');
        const leftContainer = elements.basic('div', 'left');
          ...
          projectLink.innerHTML = _data__WEBPACK_IMPORTED_MODULE_1__.default.fetch(head.uid.split('-')[0]).name;
      ...
      const due = elements.basic('input', 'due-input');
        ...
        due.type = 'date';
        due.value = _data__WEBPACK_IMPORTED_MODULE_1__.default.formatDateBrowser(head);
...
if(!_data__WEBPACK_IMPORTED_MODULE_0__.default.fetch_raw().fields[0]) {
  _data__WEBPACK_IMPORTED_MODULE_0__.default.add_field('General');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('0', 'Get groceries', '', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(2021, 0, 26, 23, 55), 'MM/dd/yyyy'));
    ...
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('0', 'Clean Shower', '', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(2021, 0, 26, 23, 55), 'MM/dd/yyyy'));
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('0', 'Sell Bike', 'dont go less than $500!!!', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(2021, 1, 8, 12, 0), 'MM/dd/yyyy'));
  ...
  _data__WEBPACK_IMPORTED_MODULE_0__.default.add_field('Work');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('1', 'Look for a job', '');
  ...
  _data__WEBPACK_IMPORTED_MODULE_0__.default.add_field('Code');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('2', 'Finish Cabbage', '');
...
_controller__WEBPACK_IMPORTED_MODULE_1__.default.initFields();
