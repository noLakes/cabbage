...
const controller = (function() {
  ...
  const open_field_edit_form = (field) => {
    ...
    edit_form.querySelector('.delete-field').addEventListener('click', () => {
      ...
      if(answer) {
        _data__WEBPACK_IMPORTED_MODULE_0__.default.remove(field.uid);
        initHome();
      }
    })
  ...
  const update_head = () => {
    ...
    if(isNaN(dateValue)) {
      ...
      dateValue = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(dateValue + 14400000), 'MM/dd/yyyy');
    }
...
_controller__WEBPACK_IMPORTED_MODULE_1__.default.initHome();

console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)('Jan/30', 'MMM/dd', new Date()));
