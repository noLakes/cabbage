...
const db = (function() {
  ...
  const add_task = (parent_uid, name, info, due=0) => {
    const task = (0,_objects__WEBPACK_IMPORTED_MODULE_0__.Task)(name, info, due);
...
if ((0,_storage__WEBPACK_IMPORTED_MODULE_1__.storageAvailable)('localStorage')) {
  ...
  if (!_data__WEBPACK_IMPORTED_MODULE_0__.default.fetch_raw().projects[0]) {
    ...
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_task('0', 'welcome', 'welcome to cabbage! a super lightweight to-do list app made by yours truly in an effort to get better at javascript', 0);
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_check('0-0', 'add your own projects (they are like a folder for your tasks)');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_check('0-0', 'make a new task for your project');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_check('0-0', "give that task a lil' description");
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_check('0-0', 'create a couple of checklist items for your new task');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_check('0-0', 'take time in life for the little things');
  }
