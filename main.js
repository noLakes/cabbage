...
const controller = (function() {
  ...
  const open_project_edit_form = (project) => {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.content.querySelector('.project-heading-container').prepend(edit_form);
  ...
  const open_task_modal = (task) => {
    ...
    if(_time__WEBPACK_IMPORTED_MODULE_2__.default.getDateStyle(task.due) && !task.complete) {
  ...
  const loadStaticHeading = (title) => {
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.content.prepend(_dom__WEBPACK_IMPORTED_MODULE_1__.render.staticHeading(title));
  }
  ...
  const loadEmptyPlaceholder = () => {
    document.querySelector('.tasks-container').appendChild(_dom__WEBPACK_IMPORTED_MODULE_1__.render.nothingDisplay());
  }
  ...
  const loadHandler = (target) => {
    if(target.classList.contains('time-link')) {
      switch(target.id) {
        case 'today':
          loadBatch(_data__WEBPACK_IMPORTED_MODULE_0__.default.dateQuery(_time__WEBPACK_IMPORTED_MODULE_2__.default.endOfDay()), false);
          loadStaticHeading('Today');
          break
        case 'upcoming':
          loadBatch(_data__WEBPACK_IMPORTED_MODULE_0__.default.dateQuery(_time__WEBPACK_IMPORTED_MODULE_2__.default.oneWeek()), false);
