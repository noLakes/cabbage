...
const controller = (function() {
  ...
  const open_head_modal = (head) => {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.modal.querySelector('button.delete').addEventListener('click', () => {
      ...
      if(answer) {
        _data__WEBPACK_IMPORTED_MODULE_0__.default.remove(head.uid);
        toggle_modal(false);
      }
    })
    ...
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.modal.querySelector('.project-link').addEventListener('click', (e) => {
      toggle_modal();
      clearActive();
      _dom__WEBPACK_IMPORTED_MODULE_1__.elements.field_links_container.querySelector(`[data-uid='${e.target.dataset.uid}']`).classList.add('active');
      loadField(e.target.dataset.uid);

    })

    if(getDateStyle(head.due)) {
      _dom__WEBPACK_IMPORTED_MODULE_1__.elements.modal.querySelector('.due-input').classList.add(getDateStyle(head.due));
    }
    toggle_modal();
  }
...
const db = (function() {
  ...
  const formatDateForPicker = (head) => {
    if(!head.due) return '';
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(Number(head.due), 'yyyy/MM/dd').replace(/\//g, '-');
  }
  ...
  return {
    ...
    leaf(leaf) {
      ...
      const checkboxContainer = elements.basic('label', 'checkbox-container');
        ...
        checkBox.addEventListener('change', (e) => {
          if(e.target.checked) {
            _data__WEBPACK_IMPORTED_MODULE_1__.default.update_item(leaf.uid, {complete : true});
          }else if(!e.target.checked) {
            _data__WEBPACK_IMPORTED_MODULE_1__.default.update_item(leaf.uid, {complete : false});
          }
        })
    ...
    head_tile(head) {
      ...
      if(head.due) {
        ...
        dueDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(head.due, 'MMM/dd').replace(/\//g, ' ');
    ...
    head_modal(head) {
        ...
        const rightContainer = elements.basic('div', 'right');
          ...
          complete.addEventListener('click', (e) => {
            if(e.target.classList.contains('done')) {
              ...
              _data__WEBPACK_IMPORTED_MODULE_1__.default.update_item(head.uid, {complete : false});
            } else {
              e.target.classList.add('done');
              _data__WEBPACK_IMPORTED_MODULE_1__.default.update_item(head.uid, {complete : true});
            }
          })
      ...
      if(!head.due) dueActions.style.display = 'none';
        ...
        due.type = 'date';
        due.value = _data__WEBPACK_IMPORTED_MODULE_1__.default.formatDateForPicker(head);
...
if(!_data__WEBPACK_IMPORTED_MODULE_0__.default.fetch_raw().fields[0]) {
  _data__WEBPACK_IMPORTED_MODULE_0__.default.add_field('General');
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('0', 'Get groceries', '', new Date(2021, 0, 26, 23, 55).getTime());
    ...
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('0', 'Clean Shower', '', new Date(2021, 0, 26, 23, 55).getTime());
    _data__WEBPACK_IMPORTED_MODULE_0__.default.add_head('0', 'Sell Bike', 'dont go less than $500!!!', new Date(2021, 1, 8, 12, 0).getTime());
