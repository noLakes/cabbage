...
const controller = (function() {
  ...
  const open_project_form = () => {
    ...
    form.querySelector('input.submit-project').addEventListener('click', (e) => {
      ...
      if(name.length > 0) {
        ...
        _dom__WEBPACK_IMPORTED_MODULE_1__.elements.new_project_button.disabled = false;
  ...
  const loadNewTaskForm = (uid) => {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_1__.elements.content.appendChild(new_task_form);
  }
  ...
  const open_task_modal = (task) => {
    ...
    if(getDateStyle(task.due)) {
      _dom__WEBPACK_IMPORTED_MODULE_1__.elements.modal.querySelector('.due-input').classList.add(getDateStyle(task.due));
    }
    toggle_modal();
  }
  ...
  return {
    ...
    task_tile(task) {
      ...
      if(task.due) {
        ...
        dueDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(task.due, 'MMM/dd').replace(/\//g, ' ');
