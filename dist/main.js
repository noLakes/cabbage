...
const controller = (function() {
  ...
  const toggle_modal = () => {
    const modal = _dom__WEBPACK_IMPORTED_MODULE_2__.elements.modal;
  ...
  const loadBatch = (arr) => {
    ...
    arr.forEach(item => {
      if(item.type === 'head') {
        ...
        _dom__WEBPACK_IMPORTED_MODULE_2__.elements.content.appendChild(_dom__WEBPACK_IMPORTED_MODULE_2__.render.leaf(item));
      }
    })
  }
